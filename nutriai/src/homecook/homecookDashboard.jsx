    ...
    <div className="homecook-dashboard">
      ...
      <div className="homecook-header">
        ...
        <div className="header-right">
          <button className="btn-switch-mode" onClick={onSwitchToConsumer}>
              ...
              <div key={recipe.id} className="recipe-card">
                ...
                <div className="recipe-price">
                  ...
                  <span className="price-value">
                    NPR{" "}
                    {Number(recipe.price || 0).toLocaleString("en-NP", {
                ...
                {(recipe.is_vegan ||
                  ...
                  <div className="dietary-tags">
                    ...
                    {recipe.is_gluten_free && (
                      <span className="tag tag-gluten">🌾 Gluten-Free</span>
                    )}
                    {recipe.is_dairy_free && (
                      <span className="tag tag-dairy">🥛 Dairy-Free</span>
                    )}
                  </div>
                )}
              ...
              <div className="form-section">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({ ...form, recipe_name: e.target.value })
                    }
                ...
                <div className="checkbox-grid">
                  ...
                  <label className="checkbox-label">
                    <input
                      ...
                      onChange={(e) =>
                        setForm({ ...form, is_dairy_free: e.target.checked })
                      }
                    />
